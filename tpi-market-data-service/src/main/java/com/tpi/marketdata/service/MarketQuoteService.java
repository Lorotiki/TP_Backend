...
public class MarketQuoteService {
    ...
    // to-do reemplazar por integración con proveedor de datos real, o al menos un repositorio local con datos históricos
    ...
    // to-do cambiar completamente por la logica vista 
